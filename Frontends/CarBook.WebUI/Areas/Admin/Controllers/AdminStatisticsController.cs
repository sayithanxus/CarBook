using CarBook.Dto.StatisticsDto;
...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminStatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #region İstatistik10
            var responseMessage10 = await client.GetAsync("https://localhost:7173/api/Statistics/BrandNameByMaxCar");
            ...
            #region İstatistik11
            var responseMessage11 = await client.GetAsync("https://localhost:7173/api/Statistics/BlogTitleByMaxBlogComment");
